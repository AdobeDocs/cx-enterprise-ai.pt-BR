...
description: Saiba como os administradores do Analytics usam a habilidade de validação de dados do Adobe Co-worker para comparar os dados do Adobe Analytics e do Customer Journey Analytics durante a atualização.
hide: true
...
O Adobe Co-worker inclui uma habilidade de validação que permite validar os dados ao atualizar do Adobe Analytics para o Customer Journey Analytics. A validação de dados é concluída em uma única conversa.
