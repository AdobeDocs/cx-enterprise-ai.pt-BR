...
# Realizar análise de dados do Customer Journey Analytics com o Colaborador
...
1. Acesse https://coworker.experience.adobe.io/chat/.
...
>[!NOTE]
>
>As figuras abaixo são dados de amostra ilustrativos de uma retailer fictícia, a TechPulse Electronics, usada para mostrar a forma da conversa.
