...
![O Assistente de IA mostra uma tabela exibindo campos relevantes para compradores ricos.](./assets/audience/affluent-buyers.png)
...
![O Assistente de IA mostra uma tabela que exibe públicos que não foram ativados ou usados em campanhas nos últimos 30 dias.](./assets/audience/not-activated.png)
...
![O Assistente de IA lista o público-alvo que foi mapeado para um novo destino nos últimos 3 meses.](./assets/audience/new-destination.png)
...
![O Assistente de IA mostra uma tabela que exibe os maiores públicos-alvo da conta.](./assets/audience/largest-account-audience.png)
...
![O Assistente de IA exibe uma tabela que contém a definição do segmento e os nomes dos públicos-alvo com as mesmas definições de segmento.](./assets/audience/similar-descriptions.png)
...
![O Assistente de IA exibe uma tabela que contém os nomes dos públicos-alvo que compartilham as mesmas regras de público-alvo.](./assets/audience/same-rules-different-names.png)
...
![O Assistente de IA mostra que não há definições de segmento duplicadas para destinos diferentes.](./assets/audience/same-rules-different-destinations.png)
...
![O Assistente de IA exibe uma tabela que contém os nomes e as IDs dos públicos-alvo da conta que compartilham as mesmas regras de público-alvo.](./assets/audience/duplicate-account-audience.png)
...
![O Assistente de IA informa o tamanho atual do público-alvo que foi perguntado.](./assets/audience/current-size.png)
...
![O Assistente de IA fornece informações sobre o público-alvo com mais perfis, incluindo nome e ID de público-alvo.](./assets/audience/largest-audience.png)
...
![O Assistente de IA exibe uma tabela que lista os nomes de todos os públicos-alvo que correspondem à consulta. Ele também mostra o aumento percentual, o tamanho do público-alvo atual, bem como o tamanho do público-alvo anterior.](./assets/audience/increase-past-week.png)
...
![O Assistente de IA exibe uma tabela que lista os nomes de todos os públicos-alvo que correspondem à consulta. Ele também mostra o tamanho atual do público, o tamanho anterior do público, bem como a data do tamanho antigo do público.](./assets/audience/decrease-month.png)
...
![O Assistente de IA informa o nome do público-alvo que cresce mais rápido, bem como o tamanho atual e a porcentagem de crescimento.](./assets/audience/fastest-growing.png)
...
![O Assistente de IA mostra o plano para criar um público-alvo.](./assets/audience/audience-create-plan.png)
...
![Etapa 1 do plano, que é identificar as características do público-alvo.](./assets/audience/plan-step-1.png){align="center" width="80%"}

Depois de aceitar o plano, o Assistente de IA capturará as características do público-alvo com base na consulta inicial.

+++ Resposta

![A definição de público-alvo com base na consulta de usuário.](./assets/audience/audience-create-definition.png)
...
![Etapa 2 do plano, que é estimar o tamanho do público potencial.](./assets/audience/plan-step-2.png){align="center" width="80%"}
...
![A amostra de estimativa para o público-alvo potencial é exibida. O tamanho estimado e a definição do segmento são mostrados.](./assets/audience/audience-create-estimate.png)
...
![Etapa 3 do plano, que é concluir a criação do público-alvo.](./assets/audience/plan-step-3.png){align="center" width="80%"}
...
![A tela de revisão é exibida.](./assets/audience/audience-create-review.png)
...
![A proposta completa para o público-alvo é exibida.](./assets/audience/audience-create-proposal.png)

+++

O público-alvo foi criado.

![A proposta de público-alvo foi aceita e o público-alvo foi criado.](./assets/audience/audience-finish-create.png){align="center" width="80%"}
