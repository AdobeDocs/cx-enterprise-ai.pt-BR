...
Para ver o Chat do Colaborador em ação, analise o [Chat do Colaborador no Playground](./coworker/playground-coworker-chat.md) ou leia casos de uso reais, como [Validar dados de migração do AA para o CJA](./coworker/data-validation-aa-cja.md) e [Analisar o menu suspenso de conversão](./coworker/analytics-chat.md).
